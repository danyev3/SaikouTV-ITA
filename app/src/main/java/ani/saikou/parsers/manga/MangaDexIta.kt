...
class MangaDexIta : MangaParser() {

    override val name = "MangaDexIta"
    override val saveName = "manga_dexita"
    ...
    override suspend fun loadChapters(mangaLink: String, extra: Map<String, String>?): List<MangaChapter> {
        ...
        setUserText("Scarico i Capitoli...")
        ...
        setUserText("Parsing dei Capitoli...")
        (0..totalChapters step 200).reversed().toList().asyncMap { index ->
            ...
            data?.forEach {
                if (it.attributes.translatedLanguage == "it" && it.attributes.externalUrl == null) {
